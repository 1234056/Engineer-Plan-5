...
osThreadId ShootControlTasHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  ShootControlTasHandle = osThreadCreate(osThread(ShootControlTas), NULL);
...
/* USER CODE BEGIN Header_ShootControlTask */
/**
* @brief Function implementing the ShootControlTas thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ShootControlTask */
__weak void ShootControlTask(void const * argument)
{
