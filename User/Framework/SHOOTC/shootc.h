...
#ifndef GIMBAL_2026_ABOARD_SHOOTC_H
#define GIMBAL_2026_ABOARD_SHOOTC_H
...
private:
	...
	int8_t rammer_flag, permit = PERMIT,Protect_flag;//连发慢速还是有点卡
