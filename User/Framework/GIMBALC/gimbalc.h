...
//电机反馈选择
#define ECD_MODE 0//电机编码器模式
#define GYR_MODE 1//陀螺仪反馈角度
#define TOKEY_MODE 3
#define TORC_MODE 4
...
#define CRAZYRAMMER 2
	...
	//射击模式
#define NOSHOOT 0
#define SINGLESHOOT 1
#define CONTINUESHOOT 2
//舵机状态
#define SERVO_OFF 0
#define SERVO_ON 1
...
private:
	...
	float Chassis_DifGain = 15, ChassisYawTarget = 120.0f, YawBias, vz;
	float Pih_EcdUpLimit = 25, Pih_EcdLowLimit = -11, Pih_GyrUpLimit = 23, Pih_GyrLowLimit = -14;
...
//	NormalPID
	...
	NormalPID ChassisYawPid{1.5,0.0,0.32,1000};
// 	SMC
	SMC YawSMC{20, 150, 0, 0.001, 21, 27, 15000, 0.8, 0.5};

	bool CAN2_Status;
	int8_t warning,Last_Warning,CarMode,Last_CarMode,is_online,Protect_flag,Last_ProtectFlag;
