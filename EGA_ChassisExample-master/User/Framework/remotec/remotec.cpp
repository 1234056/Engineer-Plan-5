...
void cRemote::UpdateRCTarget(float* rc_target, int16_t* mode) const
{
    rc_target[0] = -static_cast<float> ((rc_left_vertical) / (7.84f * 4*10)+0.066964 );
    rc_target[1] = static_cast<float>((rc_left_horizontal) / (7.84f * 4*10)+0.01-0.003622);
    rc_target[2] = -static_cast<float>((rc_right_horizontal)+7);
    *mode = rc_switch_D;
